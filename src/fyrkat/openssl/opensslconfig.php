...
class OpenSSLConfig
{
	 ...
	 */
	private function _setDigestAlg( ?string $digestAlg ): void
	{
	 ...
	 */
	private function _setX509Extensions( ?string $x509Extensions ): void
	{
	 ...
	 */
	private function _setReqExtensions( ?string $reqExtensions ): void
	{
	 ...
	 */
	private function _setPrivateKeyBits( ?int $privateKeyBits ): void
	{
	 ...
	 */
	private function _setPrivateKeyType( ?int $privateKeyType ): void
	{
	 ...
	 */
	private function _setEncryptKey( ?bool $encryptKey ): void
	{
	 ...
	 */
	private function _setEncryptKeyCipher( ?int $encryptKeyCipher ): void
	{
	 ...
	 */
	private function _setCurveName( ?string $curveName ): void
	{
	 ...
	 */
	private function _setConfig( ?string $config ): void
	{
		$this->config = $config;
	}
